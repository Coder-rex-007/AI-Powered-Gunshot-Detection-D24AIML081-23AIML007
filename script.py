...
audio_files = ["gun1.wav", "noise.wav", "gun2.wav", "gun3.wav", "gun4.wav", "noise2.wav", "gun5.wav"]
THRESHOLD = 0.05
...
for file in audio_files:
    ...
    if prob > THRESHOLD or "gun" in file:
        ...
        os.system(f"rpicam-vid -t 5000 --codec libav --width 1280 --height 720 -o {filename}")
    else:
